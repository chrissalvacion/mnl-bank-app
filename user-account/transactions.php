...
include('php/transactions-model.php');
    ...
    <body>
        ...
        <nav class="uk-navbar-container" uk-navbar>
            <div class="uk-navbar-center">
                <ul class="uk-navbar-nav">
                    ...
                    <li class="uk-active uk-text-bold"><a href="transactions.php?user=<?php echo $userid; ?>">Transactions</a></li>
        ...
        <!-- <footer>
            <div class="uk-position-bottom">
                <p class="uk-text-meta uk-text-center">Online Bank. Version e.0.</p>
            </div>
        </footer> -->
